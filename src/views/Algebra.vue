      ...
      <div class="heading-container">
        ...
        <div>
          <div class="question-container">
            <h1 v-if="data.length > 0" class="white--text font-flabby font-weight-regular mt-3">
        ...
        <div>
          ...
          <v-layout  v-if="data.length > 0" d-flex align-center justify-space-between class="mt-2 w-100">
            ...
            <button @click.prevent="checkAnswer('d')" class="btn btn-game-choice rounded-xl font-flabby pt-2 pb-2 d-block">
...
<!-- 
  ...
  <div v-show="dialogEasy" class="modal-container">
   <div class="gamemode-modal">
    ...
    <div class="gamemode-modal--content">
     <h4 class="mt-5 font-weight-regular">
      You'll have 15 seconds to <br />
      answer each question. <br /><br />
      Translate each verbal phrases into an algebraic expression <br /><br />
      Choose your answer among <br />the choices.
     </h4>
    </div>
    <div class="gamemode-modal--btn">
     <button @click.prevent="startGame" class="btn btn-game rounded-xl pt-2 pb-2 pr-4 pl-4 font-flabby text-uppercase">
      Start
     </button>
    </div>
   </div>
  ...
  <div v-show="dialogIntermediate" class="modal-container">
   <div class="gamemode-modal">
    ...
    <div class="gamemode-modal--content">
     <h4 class="mt-5 font-weight-regular">
      You'll have 60 seconds to <br />
      answer each question. <br /><br />
      Use the distributive property to <br />
      simplify each expression. <br /><br />
      Choose your answer among <br />the choices.
     </h4>
    </div>
    <div class="gamemode-modal--btn">
